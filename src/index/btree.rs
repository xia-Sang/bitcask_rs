...
mod tests{
    ...
    fn test_btree_put(){
        let bt=Btree::new();
        let res1=bt.put("gsegseg".as_bytes().to_vec(), LogRecordPos{file_id:1,offset:10});
        assert_eq!(res1,true);

        let res2=bt.put("fsefsegs".as_bytes().to_vec(), LogRecordPos{file_id:2,offset:10});
        assert_eq!(res2,true);
    }
    #[test]
    fn test_btree_get(){
        ...
        let res2=bt.put("sang".as_bytes().to_vec(), LogRecordPos{file_id:2,offset:10});
        assert_eq!(res2,true);
